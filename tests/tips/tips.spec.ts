...
import { getRandomNumber, getRandomString } from '../../utils/data-helpers' //do pierwszego testu dodalismy zmienne o kreowaniu randomowych liczb i ciagu znakow

test.describe('Tips & Trics Section', () => {
  ...
  test('Test Skip Browser', async ({ page, browserName }) => {
    ...
    await page.goto('https://www.example.com')
    //sometimes sth doesn't work in Safari
  })
  ...
  const people = ['Mike', 'Judy', 'Peter', 'Elon', 'Alice'] // creating test for five persons
